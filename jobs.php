...
<div class="wrapper">
                ...
                <ul class="nav nav-pills nav-stacked tree" data-widget="tree">
                  <li class="treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                        <input class="cityitem" type="checkbox" name="delhi" value="Delhi">Delhi<br>
						<input class="cityitem" type="checkbox" name="kouba" value="Kouba">Kouba<br>
                    </ul>
                  </li>
                  <li class="treeview menu-open">
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2020 <a href="learningfromscratch.online">Job Portal</a>.</strong> All rights
    reserved.
    </div>
  </footer>
...
var citemarr;
  $(".cityitem").on("click", function(e) {
	citemarr=document.getElementsByClassName("cityitem");
    var searchResult = $(this).data("target");
    var filter = "city";
    if(searchResult != "") {
      $("#pagination").twbsPagination('destroy');
  ...
  function Search(val, filter) {
    ...
    $pagination.twbsPagination({
      ...
      onPageClick: function (e, page) {
        ...
        $("#target-content").html("loading....");
        $("#target-content").load("search.php?page="+page+"&search="+val+"&filter="+filter,function() {
			if(document.getElementById('sag')){
			numtotal=document.getElementById('sag').innerText;
			}
			console.log('log'+numtotal);
			$pagination.twbsPagination('destroy');
	
			var $pagination1 = $('#pagination');
			$pagination1.twbsPagination({
			totalPages: Math.ceil(numtotal/4),
			visible: 5,
			onPageClick: function (e, page) {
				e.preventDefault();
				val = encodeURIComponent(val);
